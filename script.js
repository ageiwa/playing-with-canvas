...
cvs.addEventListener('click', async (e) => {
    ...
    // await animationLine(x, y, x+50, y, 5);
    // await animationLine(x+50, y, x+50, y+50, 5);
    // await animationLine(x+50, y+50, x, y+50, 5);
    // await animationLine(x, y+50, x, y, 5);

    ctx.arc(250, 250, 100, 0, (Math.PI/180)*50);
    ctx.stroke();
